...
namespace Drypoint.Unity.Extensions
{
    public static class EnumExtensions
    {
        ...
        public static List<OptionModel> ToList(this Enum value, bool ignoreNull = false)
        {
            ...
            return Enum.GetValues(enumType).Cast<Enum>()
                .Where(m => !ignoreNull || !m.ToString().Equals("Null")).Select(x => new OptionModel
                {
        ...
        public static List<OptionModel> ToList<T>(bool ignoreNull = false)
        {
